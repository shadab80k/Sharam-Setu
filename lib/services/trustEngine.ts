import type { User, WorkerProfile, Verification, Assessment, WorkHistory, Application, Payment, SafetyReport, FraudSignal } from "@/lib/types";
import { clamp, trustLabel } from "@/lib/utils";
