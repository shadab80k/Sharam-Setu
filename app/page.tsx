...
export default function LoginPage() {
  ...
  function handleDemoAccess(role: "worker" | "contractor" | "admin") {
    ...
    setTimeout(() => router.push(`/${role}/dashboard`), 200);
  }
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-navy-900 text-white p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] font-semibold text-orange-500 tracking-widest">AI</div>
            </div>
          </div>
        </div>
        ...
        <div className="relative space-y-6">
          <h1 className="text-4xl xl:text-5xl font-bold leading-tight">
            ...
            <span className="text-orange-500">India's informal workforce</span>
          </h1>
          ...
          <div className="grid grid-cols-1 gap-3 pt-4">
            {[
              ...
              <div key={b.text} className="flex items-center gap-3">
                <div className="h-9 w-9 rounded-lg bg-orange-600/20 text-orange-500 flex items-center justify-center">
                  {b.icon}
                </div>
      ...
      {/* Right login panel */}
      <div className="flex-1 flex flex-col p-6 sm:p-10 bg-cream-50">
        ...
        <div className="m-auto w-full max-w-md">
          ...
          {mode === "otp" && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="flex gap-2">
                {otp.map((d, i) => (
                  <input
                    ...
                    className="h-12 w-12 text-center text-lg font-bold rounded-lg border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-orange-500/30 focus:border-orange-500"
                  />
                ))}
              </div>

              <div className="flex items-center justify-between text-sm">
                <button onClick={() => setMode("phone")} className="text-orange-600 font-medium">
                  Change number
                </button>
                <button className="text-gray-600">Resend in 28s</button>
              </div>
              ...
              <div className="rounded-lg bg-blue-100 border border-blue-100 p-3 text-xs text-blue-600 flex items-start gap-2">
